...
- การเพิกถอน 3 บทอ่านคำร้องจาก slot ในฐานข้อมูลก่อนยกเลิก ไม่อาศัย cache ของอาจารย์อย่างเดียว หากมีการจองแทรกระหว่างอ่านและบันทึก rules จะปฏิเสธการเพิกถอนที่ทิ้งคำร้องเปิดไว้ ให้ลองบันทึกใหม่เพื่ออ่าน slot ล่าสุด การคืนผลผ่านไม่คืนคำร้องที่ถูกยกเลิกแล้ว และคำยืนยันจองที่มาช้าไม่ทับสถานะยกเลิก
...
- **อาจารย์ที่ปรึกษาร่วมโครงงาน (ถ้ามี)**: โปรไฟล์นักศึกษามี dropdown 2 ช่อง ใช้รายชื่อและตัวเลือก “อื่น ๆ (ระบุ)” เหมือนที่ปรึกษาหลัก ไม่บังคับเลือก บันทึกเป็น `coAdvisorId` (ช่องเดิม/คนที่ 1) และ `coAdvisor2Id` (คนที่ 2) เลือก “ไม่ระบุ” เพื่อล้างค่าเดิมได้ อาจารย์ร่วมทั้งสองเห็นนักศึกษาในรายการที่ดูแล
